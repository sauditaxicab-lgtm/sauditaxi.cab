...
export const metadata: Metadata = {
    ...
    description: 'Privacy Policy for Saudi Taxi - Learn how we collect, use, and protect your personal information in accordance with Saudi Data Protection Laws.',
};
