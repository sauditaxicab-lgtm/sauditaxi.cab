...
export function GMCYukonContent() {
    ...
    useEffect(() => {
        const interval = setInterval(() => {
            setActiveIndex((prev) => (prev + 1) % yukonGallery.length);
        }, 5000);
        return () => clearInterval(interval);
    }, []);

    const activeImage = yukonGallery[activeIndex];
        ...
        <main className="bg-white min-h-screen font-sans text-zinc-900 overflow-x-hidden">
                ...
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-12">
                        {[
                            ...
                            { icon: Star, title: "VIP Executive Status", desc: "The preferred choice for dignitaries and families who refuse to compromise on luxury.", highlight: true },
                            { icon: Briefcase, title: "Massive XL Boot", desc: "True 7-seater with deep trunk space. Fits 7 large suitcases easily without folding seats.", highlight: false }
                        ].map((item, i) => (
                            <motion.div
                                key={i}
                                whileHover={{ y: -15 }}
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className="text-center mb-12 md:mb-20">
                        <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 px-4 py-2 md:px-6 md:py-3 rounded-full mb-6">
                            ...
                            <span className="text-white/60 text-[10px] md:text-xs font-bold tracking-widest uppercase">VIP Rated</span>
                        </div>
                        <h2 className="text-white mb-6">Chosen by Executives</h2>
                        <p className="text-white/40 text-sm md:text-lg uppercase tracking-widest font-black">Experience the Difference in Detail</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 max-w-6xl mx-auto mb-12 md:mb-16">
                        <div className="bg-white/[0.03] backdrop-blur-md rounded-[2rem] md:rounded-[3rem] p-8 md:p-12 border border-white/10 shadow-2xl lg:col-span-1 relative">
                            <div className="absolute top-0 right-6 md:right-10 -translate-y-1/2 bg-luxury-gold text-black text-[8px] md:text-[10px] font-black uppercase tracking-widest px-3 py-1.5 md:px-4 md:py-2 rounded-full">Recent Review</div>
                            <p className="text-xl md:text-2xl font-serif italic text-white leading-relaxed mb-8 md:mb-10">
                                "Ordered the Yukon for my parents. They said it was the most comfortable ride of their lives. Driver was in a suit, car was brand new."
                            </p>
                            <div className="flex items-center gap-4 md:gap-5">
                                <div className="size-12 md:size-14 rounded-full bg-luxury-gold/20 flex items-center justify-center font-bold text-luxury-gold border border-luxury-gold/20">FA</div>
                                <div>
                                    <span className="block text-white font-bold text-base md:text-lg">Fahad A.</span>
                                    <span className="text-white/40 text-[8px] md:text-[10px] uppercase tracking-widest font-black">January 2026 • VIP Transfer</span>
                                </div>
                            </div>
                        </div>
            ...
            <section className="py-20 md:py-32 bg-zinc-50">
                <div className="container mx-auto px-6 max-w-4xl">
                    <div className="text-center mb-12 md:mb-20">
                        ...
                        <h2 className="text-black mb-4">VIP Questions</h2>
                        <p className="text-black/40 text-base md:text-lg font-light tracking-wide">Details about the Yukon VIP experience.</p>
                    </div>
            ...
            <section className="py-16 md:py-24 bg-white relative overflow-hidden">
                ...
                <div className="container mx-auto px-6 text-center max-w-4xl relative z-10">
                    ...
                    >
                        <h3 className="text-3xl md:text-7xl font-serif font-bold mb-6 md:mb-10 text-white leading-tight">Upgrade to <span className="text-luxury-gold italic">First Class</span></h3>
                        <p className="text-white/40 text-[8px] md:text-xs font-black uppercase tracking-[0.3em] md:tracking-[0.5em] mb-8 md:mb-12">Limited V8 Availability</p>
