...
export function HyundaiStariaContent() {
    ...
    useEffect(() => {
        const interval = setInterval(() => {
            setActiveIndex((prev) => (prev + 1) % stariaGallery.length);
        }, 5000);
        return () => clearInterval(interval);
    }, []);

    const activeImage = stariaGallery[activeIndex];
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className="text-center mb-12 md:mb-20">
                        <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 px-4 py-2 md:px-6 md:py-3 rounded-full mb-6">
                            ...
                            <span className="text-white/60 text-[10px] md:text-xs font-bold tracking-widest uppercase">Family Approved</span>
                        </div>
                        <h2 className="text-white mb-6">Loved by Families Worldwide</h2>
                        <p className="text-white/40 text-sm md:text-lg uppercase tracking-widest font-black">Trusted for Umrah Family Transfers</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 max-w-6xl mx-auto mb-12 md:mb-16">
                        <div className="bg-white/[0.03] backdrop-blur-md rounded-[2rem] md:rounded-[3rem] p-8 md:p-12 border border-white/10 shadow-2xl lg:col-span-1 relative">
                            <div className="absolute top-0 right-6 md:right-10 -translate-y-1/2 bg-luxury-gold text-black text-[8px] md:text-[10px] font-black uppercase tracking-widest px-3 py-1.5 md:px-4 md:py-2 rounded-full">Top Rated MPV</div>
                            <p className="text-xl md:text-2xl font-serif italic text-white leading-relaxed mb-8 md:mb-10">
                                "The Hyundai Staria was a game changer for our family. The captain seats made the journey from Makkah to Madinah feel like a luxury cruise."
                            </p>
                        ...
                        <div className="space-y-6 md:space-y-8">
                            {[
                                { name: "Fatima S.", city: "Jakarta, Indonesia", text: "Best vehicle for large families. Very clean and the driver was excellent." },
                                { name: "Omar H.", city: "Doha, Qatar", text: "Staria is the way to go for luxury group travel in Saudi. Worth every riyal." }
                            ].map((r, i) => (
            ...
            <section className="py-20 md:py-32 bg-zinc-50">
                <div className="container mx-auto px-6 max-w-4xl">
                    <div className="text-center mb-12 md:mb-20">
                        ...
                        <h2 className="text-black mb-4">Your Questions, Answered</h2>
                        <p className="text-black/40 text-base md:text-lg font-light tracking-wide">Everything families need to know about the Staria experience.</p>
                    </div>
            ...
            <section className="py-16 md:py-24 bg-white relative overflow-hidden">
                ...
                <div className="container mx-auto px-6 text-center max-w-4xl relative z-10">
                    ...
                    >
                        ...
                        <p className="text-white/40 text-[8px] md:text-xs font-black uppercase tracking-[0.3em] md:tracking-[0.5em] mb-8 md:mb-12">Luxury Family Limited Availability</p>
                    ...
                    <div className="mt-12">
                        <Link href="/fleet" className="inline-flex items-center gap-2 text-luxury-gold/60 hover:text-luxury-gold transition-colors text-xs uppercase tracking-widest font-bold">
                            <ArrowLeftIcon size={14} className="mr-2" /> Back to Fleet
                        </Link>
                    </div>
                </div>
            </section>
