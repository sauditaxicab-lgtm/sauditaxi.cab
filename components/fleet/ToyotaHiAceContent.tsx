                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-20">
                        <div className="lg:w-1/2 z-10 text-center lg:text-left order-2 lg:order-1">
                            ...
                            <p className="text-zinc-400 text-base md:text-lg font-light mb-8 max-w-lg mx-auto lg:mx-0 leading-relaxed">
                                The **Toyota HiAce** is the ultimate high-roof solution for <strong>private group travel</strong>. Our <Link href="/fleet/toyota-hiace-11-seater-taxi" className="text-luxury-gold hover:underline font-bold">11-seater HiAce taxi</Link> is engineered for large families and pilgrimage groups seeking comfortable <Link href="/services/ziyarat-tours" className="text-luxury-gold hover:underline">Ziyarat tours in Madinah</Link> or bulk <Link href="/services/airport-transfers" className="text-luxury-gold hover:underline">Jeddah Airport group transfers</Link>. Capable of carrying 10-12 large bags, it is the perfect vehicle for the 4-hour <strong>Makkah to Madinah</strong> intercity route, ensuring all pilgrims stay together in one air-conditioned cabin.
                            </p>
