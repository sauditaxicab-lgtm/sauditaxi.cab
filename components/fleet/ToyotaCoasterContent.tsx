...
export function ToyotaCoasterContent() {
    ...
    useEffect(() => {
        const interval = setInterval(() => {
            setActiveIndex((prev) => (prev + 1) % coasterGallery.length);
        }, 5000);
        return () => clearInterval(interval);
    }, []);

    const activeImage = coasterGallery[activeIndex];
        ...
        <main className="bg-white min-h-screen font-sans text-zinc-900 overflow-x-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className="text-center mb-12 md:mb-20">
                        <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 px-4 py-2 md:px-6 md:py-3 rounded-full mb-6">
                            ...
                            <span className="text-white/60 text-[10px] md:text-xs font-bold tracking-widest uppercase">Jamat Approved</span>
                        </div>
                        <h2 className="text-white mb-6">Trusted by Large Groups</h2>
                        <p className="text-white/40 text-sm md:text-lg uppercase tracking-widest font-black">Seamless Logistics for 20+ Passengers</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 max-w-6xl mx-auto mb-12 md:mb-16">
                        <div className="bg-white/[0.03] backdrop-blur-md rounded-[2rem] md:rounded-[3rem] p-8 md:p-12 border border-white/10 shadow-2xl lg:col-span-1 relative">
                            <div className="absolute top-0 right-6 md:right-10 -translate-y-1/2 bg-luxury-gold text-black text-[8px] md:text-[10px] font-black uppercase tracking-widest px-3 py-1.5 md:px-4 md:py-2 rounded-full">Group Leader Choice</div>
                            <p className="text-xl md:text-2xl font-serif italic text-white leading-relaxed mb-8 md:mb-10">
                                "Coaster was the best decision for our Ziyarat group. We stayed together, prayed together, and moved together without losing anyone."
                            </p>
                        ...
                        <div className="space-y-6 md:space-y-8">
                            {[
                                { name: "Hassan B.", city: "Lahore, Pakistan", text: "Driver knew all the Ziyarat spots in Madinah. Very helpful with our elderly members." },
                                { name: "Fatima K.", city: "London, UK", text: "AC was very strong, extremely important for us coming from cold weather." }
                            ].map((r, i) => (
            ...
            <section className="py-20 md:py-32 bg-zinc-50">
                <div className="container mx-auto px-6 max-w-4xl">
                    <div className="text-center mb-12 md:mb-20">
                        ...
                        <h2 className="text-black mb-4">Group Questions</h2>
                        <p className="text-black/40 text-base md:text-lg font-light tracking-wide">Details about the Toyota Coaster experience.</p>
                    </div>
                    ...
                    <FAQSection
                        ...
                        items={[
                            ...
                            },
                            {
                                ...
                                answer: "Yes, the Coaster has a rear boot and overhead racks. For large groups with heavy shopping, we can attach a luggage trailer."
                            },
                            {
                                question: "Is there a microphone for the group leader?",
                                answer: "Yes, most of our Coasters are equipped with a PA system and microphone, perfect for Ziyarat guides."
                            },
                            {
                                question: "Can the bus access all hotel drop-off points?",
                                answer: "Generally yes, but some hotels in Makkah/Madinah have height restrictions. Our drivers know the best drop-off points close to the Haram."
                            }
                        ]}
                    />
                </div>
            ...
            <section className="py-16 md:py-24 bg-white relative overflow-hidden">
                ...
                <div className="container mx-auto px-6 text-center max-w-4xl relative z-10">
                    ...
                    >
                        <h3 className="text-3xl md:text-7xl font-serif font-bold mb-6 md:mb-10 text-white leading-tight">Secure Transport for <span className="text-luxury-gold italic">Your Jamat</span></h3>
                        <p className="text-white/40 text-[8px] md:text-xs font-black uppercase tracking-[0.3em] md:tracking-[0.5em] mb-8 md:mb-12">High Demand for Season</p>
